...
public class HttpUtils {
    ...
    private static final MediaType DATA = MediaType.parse("application/request-data");
     ...
     * @throws IOException
     */
    public static String postCookie(String url, List<Cookie> cookies, String json) throws IOException {
     ...
     * @throws IOException
     */
    public static String postHeader(String url,String sessionId,String json) throws IOException {
        RequestBody body= RequestBody.create(JSON,json);
        Request request = new Request.Builder().
                url(url).
                post(body).
//                header(WebConfig.ZHENG_UPMS_SERVER_SESSION_ID,sessionId).
//                header(WebConfig.ZHENG_UPMS_USER_INFO,sessionId).
                build();
